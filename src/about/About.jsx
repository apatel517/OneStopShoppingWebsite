...
const About = () => {
    return (
        <div>
            <PageHeader title={"Welcome to Shopping Cart"} curPage={"About"} />
                    ...
                    <div className="row justify-content-center row-cols-xl-2 row-cols-1 align-items-center">
                        ...
                        <div className="col">
                            <div className="about-left">
                                ...
                                <p>Shopping Cart is your one-stop destination for all your shopping needs. With a wide range of products and seamless shopping experience, we strive to make your online shopping journey delightful and convenient. Explore our extensive collection and discover amazing deals on a variety of products.</p>
                            </div>
                        </div>
            ...
            <div className="about-us-section style-3 padding-tb section-bg">
                <div className="container">
                    ...
                    <p>Founded with a vision to revolutionize the online shopping experience, Shopping Cart is committed to offering high-quality products, exceptional customer service, and unbeatable value to our customers. With years of experience in the e-commerce industry, we continuously strive to exceed your expectations and provide you with an unparalleled shopping journey.</p>
                </div>
            </div>
            <div className="call-to-action-section style-3 padding-tb section-bg">
                <div className="container">
                    <div className="section-header">
                        <h2>Start Exploring Shopping Cart Today</h2>
                    </div>
            ...
            <div className="testimonials-section style-3 padding-tb section-bg">
                <div className="container">
                    ...
                    <div className="testimonial-item">
                        ...
                        <div className="testimonial-item">
                            <p>"I love shopping at ShoppingCart! The website is easy to navigate, and the shipping is super fast. Highly recommended!" - Jane Smith</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="contact-info-section padding-tb ">
                <div className="container">
                    ...
                    <p className="text-dark bg-white">
                        Email: info@shoppingcart.com <br />
                        Phone: +19812452620<br />
                        Address: 123 Shopping Street,<br />
                                 Chicago,<br />
                                 Illinois,60616<br />
                                 Usa
                    </p>
